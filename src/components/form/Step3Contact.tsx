...
export function Step3Contact({ formData, errors, onChange }: Step3ContactProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        <p className="text-sm text-blue-800">
          <strong>Privasi Terjamin:</strong> Data kontak Anda hanya digunakan untuk proses transaksi dan tidak akan dibagikan kepada pihak ketiga.
        </p>
      </div>
    </div>
  );

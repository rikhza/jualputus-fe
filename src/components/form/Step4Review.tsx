...
export const Step4Review = memo(function Step4Review({
	formData,
}: Step4ReviewProps) {
	...
	return (
		<div className="space-y-6">
				...
				<div className="space-y-3">
					<div className="flex justify-between">
						...
						<span className="font-medium text-slate-900">
							{categoryLabels[formData.category as string]}
						</span>
					</div>
					<div className="flex justify-between">
					...
					<div className="flex justify-between">
						...
						<span className="font-medium text-slate-900">
							{
								conditionLabels[
									formData.physical_condition as string
								]
							}
						</span>
					</div>
					...
					<div>
						...
						<div className="flex flex-wrap gap-2">
							{formData.functional_features.map((f) => {
								const feature = functionalFeatures.find(
									(ff) => ff.value === f
								);
								return (
									<span
			...
			<div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
				<p className="text-sm text-slate-700">
					Dengan menekan tombol <strong>Submit</strong>, Anda
					menyetujui{" "}

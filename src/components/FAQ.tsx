...
export function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Saat ini layanan pickup tersedia untuk wilayah Jabodetabek, Bandung, Surabaya, dan kota-kota besar lainnya. Untuk wilayah di luar area tersebut, Anda dapat mengirimkan perangkat ke alamat kami dengan biaya pengiriman yang akan kami ganti setelah transaksi selesai.'
    }
  ];
